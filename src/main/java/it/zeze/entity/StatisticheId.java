...
public class StatisticheId implements java.io.Serializable {
	...
	private byte mediaVoto;
	private byte mediaVotoFm;
	...
	public StatisticheId(int idGiocatore, int idGiornata, byte mediaVoto, byte mediaVotoFm, int goalFatti, int goalRigore, int goalSubiti, int rigoriParati, int rigoriSbagliati, int autoreti, int assist, int ammonizioni, int espulsioni) {
	...
	@Column(name = "media_voto", nullable = false, precision = 2, scale = 0)
	public byte getMediaVoto() {
		return this.mediaVoto;
	}

	public void setMediaVoto(byte mediaVoto) {
		this.mediaVoto = mediaVoto;
	}

	@Column(name = "media_voto_fm", nullable = false, precision = 2, scale = 0)
	public byte getMediaVotoFm() {
		return this.mediaVotoFm;
	}

	public void setMediaVotoFm(byte mediaVotoFm) {
		this.mediaVotoFm = mediaVotoFm;
	}
	...
	public int hashCode() {
		...
		result = 37 * result + this.getMediaVoto();
		result = 37 * result + this.getMediaVotoFm();
